...
# Enter vertices in stage 3 separated by spaces: 4 5
# Enter vertices in stage 4 separated by spaces: 6

# Enter the number of edges from vertex 1 in stage 1: 2
...
# Enter destination vertex and cost separated by spaces: 5 3

# Enter the number of edges from vertex 3 in stage 2: 2
# Enter destination vertex and cost separated by spaces: 4 3
# Enter destination vertex and cost separated by spaces: 5 2

# Enter the number of edges from vertex 4 in stage 3: 1
# Enter destination vertex and cost separated by spaces: 6 2

# Enter the number of edges from vertex 5 in stage 3: 1
# Enter destination vertex and cost separated by spaces: 6 1

# Enter the number of edges from vertex 6 in stage 4: 0

# The minimum cost of the multistage graph is: 7
# The optimal path is: 1 2 5 6